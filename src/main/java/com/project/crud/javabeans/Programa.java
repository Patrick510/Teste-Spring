...
public class Programa {
	...
	public String getNomeAutoresNaoServidor() {
		return autores.stream().filter(autor -> !("servidor".equalsIgnoreCase(autor.getVinculo()) || "professor".equalsIgnoreCase(autor.getVinculo()))).map(Autor::getNome).collect(Collectors.joining(", "));
	}
